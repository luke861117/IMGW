...
while True:
    ...
    for (x1, y1), (x2, y2) in demoImg:    
        cv2.arrowedLine(img, (x1, y1), (x2, y2), (0, 255, 0),thickness=1, line_type=cv2.LINE_4, shift=0, tipLength=0.3)
    # print(arrows)
    cv2.imwrite("D:\\20201125\\FB\\Arrow\\cut_movie_10_no_net_RGB\\{}.png".format(counter), img)
    cv2.imshow('flow', img) 
    counter = counter + 1      
